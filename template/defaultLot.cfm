...
<TR><A NAME="description"></A><CFOUTPUT><TD BGCOLOR="#navBottomTableBg#"><FONT SIZE=4 COLOR="#navTableFont#" FACE="arial"></CFOUTPUT><B>&nbsp;Description</B></FONT></TD></TR>
<TR><TD><BR>
...
<CFELSE>
	<CFQUERY NAME=getWinningBids DATASOURCE="#EAdatasource#">
		SELECT Member.username, Bid.bidPrice, Bid.bidQuantityWin, Bid.bidEditDateTime
